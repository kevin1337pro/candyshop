...
Einzelgrößen: `docs/image-sizes.json` im vollständigen Repository. Reproduzierbarer Export: `scripts/optimize-images.mjs`, Sharp 0.35.x. Bei lokal installiertem Sharp: `node scripts/optimize-images.mjs`; alternativ `CANDY_SHARP_MODULE` auf einen vorhandenen Sharp-Modulpfad setzen. Sharp wird nicht im Produktionscontainer benötigt.
